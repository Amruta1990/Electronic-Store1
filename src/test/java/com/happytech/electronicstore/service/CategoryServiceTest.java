...
public class CategoryServiceTest extends BaseTest {
    ...
    public void getAllcategoriesTest() {
        ...
        PagableResponse<CategoryDto> allcategories = categoryService.getAllCategory(1, 5, "brand", "asc");
    ...
    public void searchCategoryTest() {
        Mockito.when(categoryRepo.findByTitleContaining(Mockito.anyString())).thenReturn(categories);
